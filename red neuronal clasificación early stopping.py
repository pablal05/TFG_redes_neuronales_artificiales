# -*- coding: utf-8 -*-
"""
Created on Sat Jun 25 21:47:03 2022
...
def f_coste(W2,W3,W4,b2,b3,b4,x1,x2,y):
...
def forward(W2,b2,W3,b3,W4,b4,x,y):
    X = np.array([[x,y]]).T
    a2 = activa(X,W2,b2)
    a3 = activa(a2,W3,b3)
    a4 = activa(a3,W4,b4)
...
def red_early_stopping(iteraciones, x1,x2,y, gen1, gen2, Y,W2o,W3o,W4o,b2o,b3o,b4o, mu= 0.05, tolerancia = 5):
    ...
    while contador < tolerancia and ite < iteraciones:
        ...
        ite += saltos
        if error_gen <=0.25 and (error_min < error_gen or abs(error_min - error_gen)<0.01):
            contador += 1
